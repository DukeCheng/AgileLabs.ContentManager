...
namespace AgileLabs.ContentManager.UEditor
{
    ...
    public abstract class Handler
    {
        ...
        protected void WriteToHtml(TextWriter writer, string value)
        {
            if (string.IsNullOrWhiteSpace(value))
                return;
        ...
        protected void WriteJson(object response)
        {
            ...
            else
            {
                ...
                //Write(string.Format("{0}({1});", jsonpCallback, json));
                Output.Write(string.Format("{0}({1});", jsonpCallback, json));
            }
        }
    }
